...
async function o(c) {
  ...
  return get(
    "https://raw.githubusercontent.com" + l.pathname.split("/blob").join("")
  )
    .then((a) => {
			console.log(l)
      const h = l.hash
...
require("express")()
  .use("/", (q, v) => {
    o(decodeURIComponent(q.query.q)).then((a) => v.json(a));
  })
  .listen(8080);
//コードenvにつめてたせいでワケワカメになってる()
//草
//prettier入れます()
//prettier完了